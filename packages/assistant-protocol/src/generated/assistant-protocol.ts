export const SOFTWARE_VERSION = "0.25.3" as const;
export const MIN_COMPATIBLE_VERSION = "0.25.3" as const;
 ...
 * 点击工具事件后按需读取的详情。
 */
export type ToolDetailSnapshot = { owner: ConversationOwner, message_id: MessageId, run_id: RunId | null, call_id: ToolCallId, tool_name: string, mcp_identity?: McpToolIdentity, status: ToolActivityStatus, input: ToolInputSnapshot,
/**
 ...
 * 工具详情中经过脱敏和结构化的输入。
 */
export type ToolInputSnapshot = { "type": "general", summary: string, } | { "type": "delegation", title: string, task_summary: string, } | { "type": "file", operation: string, path: string, } | { "type": "shell", command: string, working_directory: string, timeout_ms: number, process_mode: string, } | { "type": "mcp", identity: McpToolIdentity, arguments_json: string, } | { "type": "image_inspection", image_paths: Array<string>, goal: string, background: string | null, } | { "type": "unavailable" };
