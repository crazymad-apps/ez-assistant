export const SOFTWARE_VERSION = "0.25.2" as const;
export const MIN_COMPATIBLE_VERSION = "0.25.2" as const;

// This file was generated by [ts-rs](https://github.com/Aleph-Alpha/ts-rs). Do not edit this file manually.

export type AcceptedSessionCommand = { input_id: InputId, command: SessionCommand, is_duplicate: boolean, };
 ...
 */
export type QueuedInputSnapshot = { input_id: InputId, text_preview: string, submitted_at_ms: number, position: number, is_prioritized: boolean, source: ConversationInputSourceSnapshot,
/**
 ...
 */
export type RuntimeHostCapabilities = { min_compatible_version: string, runtime_version: string, max_command_bytes: number, max_attachment_bytes: number | null, sse: boolean, streaming_upload: boolean,
/**
 ...
 */
export type UserTerminalControl = { "type": "open", client_compatibility: ClientCompatibility | null, bearer: string | null, source: UserTerminalSource, size: UserTerminalSize, } | { "type": "resize", size: UserTerminalSize, } | { "type": "ack" } | { "type": "close" };

/**
 * 只对所属连接可见。Closed 表示 PTY 已完成清理，Error 不假称回收成功。
 */
export type UserTerminalNotice = { "type": "compatibility_error", error: RuntimeCompatibilityError, } | { "type": "created", terminal_id: string, directory_name: string, } | { "type": "exited", code: number, } | { "type": "error", message: string, } | { "type": "input_ack" } | { "type": "closed" };
