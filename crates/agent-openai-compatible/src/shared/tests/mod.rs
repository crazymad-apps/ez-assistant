...
use crate::{
    BearerCredential, ChatProtocolAdapter, ChatRequest, ChatStreamOptions, ObservedTransport,
    OpenAiChatCompletionsService, ProviderWireEvent, ProviderWireObserver, RecordedWireRequest,
...
const CONTEXT_OVERFLOW_BODY: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/fixtures/chat/errors/context_overflow.json"
));
