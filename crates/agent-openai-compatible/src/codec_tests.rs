...
use crate::{
    ...
    ChatStreamOptions, ChunkAssembler, ProtocolAdapter, decode_assistant_message,
...
/// 带 reasoning 字段的方言（用字面量构造，DeepSeek 形态；具名构造见 [`ProtocolAdapter::deepseek`]）。
...
fn limited_adapter() -> ProtocolAdapter {
    ProtocolAdapter {
