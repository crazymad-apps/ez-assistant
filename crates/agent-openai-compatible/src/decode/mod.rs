...
use crate::{ProtocolAdapter, schema::ChatUsage};

/// 把原生 assistant 消息解码为规范 parts。
///
/// 按 ProtocolAdapter 字段名从 extra map 读取 reasoning 文本。
///
...
/// 嵌套明细缺失时再按 ProtocolAdapter 声明的扁平字段名查取（DeepSeek 的
/// `prompt_cache_hit_tokens`，见
/// <https://api-docs.deepseek.com/api/create-chat-completion/>）。
pub(super) fn map_usage(usage: &ChatUsage, adapter: &ProtocolAdapter) -> TokenUsage {
