...
use crate::{
    BodyStream, ChatChunk, ChatErrorBody, ChunkAssembler, ProtocolAdapter, ReqwestTransport,
    SseParser, Transport, TransportError, TransportRequest, TransportTimeouts, decode_error_body,
    encode::encode_request_with_images,
};
...
///
/// 构造时注入 base URL、credential、模型名、[`ProtocolAdapter`] 与 [`Transport`]——一个
